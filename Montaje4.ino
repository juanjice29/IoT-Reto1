...
const char ssid[] = "Casa Prado 2.4G WIFI ET B";
//Contraseña de la red Wifi
const char pass[] = "Jpba.1810";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "jm.jimenezc12"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "jm.jimenezc12";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "202311711";
...
void loop()
{
  ...
  if ( !isnan(h) && !isnan(t) && !isnan(ldrValue)) {
